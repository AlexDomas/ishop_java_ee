...
public class Constants {
    ...
    public static final String IMAGE_PATH = "D:/NetBeansProjects/ishop3/src/main/webapp/media/";
    
    public static final String CURRENT_SHOPPING_CART = "CURRENT_SHOPPING_CART";
    
    public static final int ORDERS_PER_PAGE = 5;

    public static final int MAX_PRODUCT_COUNT_PER_SHOPPING_CART = 15;
    ...
    public static final int MAX_PRODUCTS_PER_PRODUCTS_PAGE = 12;
