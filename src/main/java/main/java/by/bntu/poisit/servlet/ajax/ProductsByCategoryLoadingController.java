...
public class ProductsByCategoryLoadingController extends AbstractController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        List<Product> products = getProductService().listProductsByCategory(categoryUrl, getPage(req), Constants.MAX_PRODUCTS_PER_PRODUCTS_PAGE);
