...
public class SearchController extends AbstractController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        List<?> products = getProductService().listProductsBySearcherProductForm(sPF, 1, Constants.MAX_PRODUCTS_PER_PRODUCTS_PAGE);
        req.setAttribute("products", products);
        int totalCount = getProductService().countProductsBySearcherProductForm(sPF);
        ...
        req.setAttribute("searcherProductForm", sPF);
